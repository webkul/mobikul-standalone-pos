...
@Database(entities = {Administrator.class, Category.class, Product.class, Customer.class, OrderEntity.class
        , HoldCart.class, CashDrawerModel.class, Options.class, OptionValues.class, Tax.class/*, Currency.class*/}, version = 19, exportSchema = false)
...
// Change the table name to the correct one
            ...
            database.execSQL(
                    "CREATE TABLE OptionValues_new (optionValueId INTEGER NOT NULL, option_id INTEGER NOT NULL," +
                            " option_value_name TEXT, option_value_price TEXT, file_name TEXT, file_type TEXT ,file_uri TEXT, option_value_sort_order INTEGER NOT NULL" +
                            ", PRIMARY KEY(optionValueId))");
            database.execSQL(
                    "INSERT INTO OptionValues_new (optionValueId, option_id, option_value_name, option_value_price, option_value_sort_order) " +
                            "SELECT optionValueId, option_id, option_value_name, option_value_price, option_value_sort_order  FROM OptionValues");
            database.execSQL("DROP TABLE OptionValues");
            database.execSQL("ALTER TABLE OptionValues_new RENAME TO OptionValues");
